...
//
//pthread_t tid[2]; //tid es una array de identificadores de hilos (threadID)
//
//int main(void)
//{
//    int i = 0;
...
// 	for(i=0; i<8;i++)
//		printf("\n soy el primer hilo y estoy en la iteración %d\n", i);
//
//    }
//    else
//    {
...
//	for(i=0; i<8;i++)
//	 printf("\n soy el segundo hilo y estoy en la iteración %d\n", i);
//    }
//
